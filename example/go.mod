...
replace example/mandel => ../mandel

replace example_big/mandel => ../mandel_big

require example/mandel v0.0.0-00010101000000-000000000000

require example_big/mandel v0.0.0-00010101000000-000000000000
